...
The REST API documentation can be found on [docs.azen.sh](https://docs.azen.sh/). The full API of this library can be found in [api.md](api.md).
...
List methods in the Azen API are paginated.
...
1. Via the `AZEN_LOG` environment variable
